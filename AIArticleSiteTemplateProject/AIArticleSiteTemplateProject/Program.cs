...
builder.Services.Configure<CDNCredentials>(builder.Configuration.GetSection("CDNServerCredentials"));
builder.Services.AddScoped<IClientServices, ClientInfoService>();
builder.Services.AddScoped<CDNServerManager>();
