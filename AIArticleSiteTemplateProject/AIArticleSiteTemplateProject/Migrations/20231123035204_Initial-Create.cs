        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathToHeaderImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PathToBodyImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalComments = table.Column<int>(type: "int", nullable: true),
                    PageViews = table.Column<int>(type: "int", nullable: true),
                    StatusId = table.Column<int>(type: "int", nullable: true),
                    PathToImage3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PathToImage4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Article_Parsed_Url = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
